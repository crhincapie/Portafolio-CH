            ...
            <motion.div variants={line2} initial="hidden" animate="visible" className="pb-20 md:pb-0">
              {slide.heroType === "profile" ? (
                <div className="relative flex items-center justify-center">
                  <div className="absolute h-[min(700px,90vw)] w-[min(700px,90vw)] rounded-full blur-3xl md:h-[700px] md:w-[700px]" style={{ background: `radial-gradient(circle at center, ${slide.accent}10 0%, ${slide.accent}05 40%, transparent 70%)` }} />
                  <div className="absolute h-[min(520px,84vw)] w-[min(520px,84vw)] rounded-full border border-[#00feff]/10 md:h-[520px] md:w-[520px]" />
