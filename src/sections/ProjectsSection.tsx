      ...
      <div className="mx-auto max-w-6xl space-y-14 px-4 md:px-6">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {featured.map((project) => (
            <ProjectCard key={project.slug} project={project} locale={locale} t={t} featured={true} />
          ))}
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {others.map((project) => (
              <ProjectCard key={project.slug} project={project} locale={locale} t={t} featured={false} />
            ))}
          </div>
        </div>
      </div>
