          ...
          <div className="flex flex-col gap-2 pt-4">
            {featured && (
              <div className="flex items-center justify-center gap-3">
                ...
                {/* Botón Ver Prototipo - Ícono + Texto */}
                <button
                  data-prototype
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[#00feff] px-6 py-3 text-sm font-medium text-zinc-950 shadow-[0_0_40px_rgba(0,254,255,0.25)] transition hover:bg-[#7afcff]"
                  title="Ver prototipo"
                >
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
            ...
            <button
              data-details
              className="w-full rounded-full bg-[#00feff] px-6 py-3 text-sm font-medium text-zinc-950 shadow-[0_0_40px_rgba(0,254,255,0.25)] transition hover:bg-[#7afcff]"
